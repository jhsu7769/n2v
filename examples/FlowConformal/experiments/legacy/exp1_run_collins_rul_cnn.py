"""Exp 1: VNN-COMP collins-rul-cnn benchmark sweep — our method only.

Usage:
    cd /home/sasakis/v/tools/n2v
    /home/sasakis/miniconda3/envs/n2v/bin/python -u -m \
        examples.FlowConformal.experiments.exp1_vnncomp_subset.exp1_run_collins_rul_cnn \
        --smoke
"""
...
_BENCHMARK_NAME = 'collins_rul_cnn'
...
def main():
    ...
    p.add_argument('--seeds', type=int, default=1,
                   help='Seeds per instance.')
    p.add_argument('--timeout', type=int, default=300,
                   help='Per-instance soft timeout (s). Bumped from 116 '
                        'because flow training adds overhead.')
    args = p.parse_args()
