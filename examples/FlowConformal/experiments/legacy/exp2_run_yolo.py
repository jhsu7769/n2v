"""Exp 2: VNN-COMP yolo_2023 sweep (our method only).

Runs the locked Phase 5d AMLS pipeline on the yolo_2023 (TinyYOLO)
instances. Sound verifiers have very limited coverage on this benchmark
in VNN-COMP 2023/2024/2025 — Exp 2 quantifies our coverage and timing.

Usage:
    cd /home/sasakis/v/tools/n2v
    /home/sasakis/miniconda3/envs/n2v/bin/python -u -m \\
        examples.FlowConformal.experiments.exp2_prob_scale.exp2_run_yolo \\
        --smoke
"""
