"""Exp 1: VNN-COMP tllverify benchmark sweep — our method only.

Note: tllverifybench networks have 2-D input and 1-D output; properties
are simple bound assertions on ``Y_0``.

Usage:
    cd /home/sasakis/v/tools/n2v
    /home/sasakis/miniconda3/envs/n2v/bin/python -u -m \
        examples.FlowConformal.experiments.exp1_vnncomp_subset.exp1_run_tllverify \
        --smoke
"""
